...
/* harmony import */ var _modules_changeImg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/changeImg */ "./src/js/modules/changeImg.js");
/* harmony import */ var _modules_checkInputsText__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/checkInputsText */ "./src/js/modules/checkInputsText.js");
...
/* harmony import */ var _modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/showMoreStyles */ "./src/js/modules/showMoreStyles.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var priceWindow = {};
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_8__["default"])('.main-slider-item', 'vertical');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_8__["default"])('.feedback-slider-item', ' ', '.main-prev-btn', '.main-next-btn');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])(priceWindow);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="phone"]');
  Object(_modules_checkInputsText__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="name"]');
  Object(_modules_checkInputsText__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="message"]');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_7__["default"])('#styles .row', '.button-transparent'); // calc('#size', '#material', '#options', '.promocode', '.calc-price', priceWindow); For calc version 1.0!

  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_1__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', priceWindow, '[data-size]', '[data-material]', '[data-options]');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modules_changeImg__WEBPACK_IMPORTED_MODULE_2__["default"])('.sizes-block');
...
var changeImg = function changeImg(imgSelector) {
  // ? Version 1.0
...
/***/ "./src/js/modules/checkInputsText.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkInputsText.js ***!
  \*******************************************/
/*! exports provided: default */
...
var checkInputsText = function checkInputsText(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkInputsText);
...
var forms = function forms(allPrice) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var name = arr[0].substring(0, 6) + dotts + arr[1];
  ...
  function postData(form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["processingPostData"])(api, formData).then(function (data) {
        console.log(data);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    var matrix = '+7 (___) ___ __ __',
        ...
        val = this.value.replace(/\D/g, ''); // console.log(def);
...
var modals = function modals() {
    ...
    function checkData(action, display) {
      if (!dataWindow) {
        ...
        trigger.forEach(function (item) {
          return item.style.display = "".concat(display);
        });
      } else {
        action();
      }
  ...
  function modalOpenByScrollToBottom(selector) {
    window.addEventListener('scroll', function () {
      ...
      if (window.pageYOffset + document.documentElement.clientHeight >= scrollHeight && btnNotPressed) {
  ...
  modalOpenByScrollToBottom('.fixed-gift'); // showModalByTime('.popup-consultation', 60000);
};
...
var showMoreStyles = function showMoreStyles(blocksSelector, trigger) {
  ...
  var mainBlock = document.querySelector(blocksSelector),
      button = document.querySelector(trigger);
  button.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourseData"])('http://localhost:3000/styles').then(function (res) {
  ...
  function createCards(element) {
    element.forEach(function (_ref) {
      var src = _ref.src,
          title = _ref.title,
          link = _ref.link;
      var blockStyle = document.createElement('div');
...
var slider = function slider(sliderWrapper, dir, prevBtn, nextBtn) {
  ...
  allSlides[0].parentNode.addEventListener('mouseenter', function () {
    clearInterval(paused);
  });
  allSlides[0].parentNode.addEventListener('mouseleave', function () {
    autoSwitching();
  });
};
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: processingPostData, getResourseData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "processingPostData", function() { return processingPostData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getResourseData", function() { return getResourseData; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__);
...
var processingPostData = function processingPostData(url, data) {
  var res;
...
var getResourseData = function getResourseData(url) {
  var res;
  return regeneratorRuntime.async(function getResourseData$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", reason ").concat(res.status));
